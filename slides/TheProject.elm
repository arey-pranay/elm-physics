...
ballBlock =
    [ Sphere3d.atPoint (Point3d.millimeters -122 172 300)
        (Length.millimeters 300)
    ]

buildingBlock : List (Block3d Meters BodyCoordinates)
buildingBlock =
    [ Block3d.from
        (Point3d.millimeters 572 222 100)
        (Point3d.millimeters 1022 472 800)
    ]
...
building : Body Id
building =
    Body.compound (List.map Physics.Shape.block buildingBlock) Building
        |> Body.withBehavior (Body.dynamic (kilograms 3.58))
