...
ballBlock =
    [ Sphere3d.atPoint (Point3d.millimeters 1800 -550 400)
...
buildingBlock1 =
    [ Block3d.from
        (Point3d.millimeters 1500 -1000 150)
        (Point3d.millimeters -1000 -500 250)
    ]

buildingBlock2 : List (Block3d Meters BodyCoordinates) --rightmost
buildingBlock2 =
    [ Block3d.from
        (Point3d.millimeters -500 -850 150)
        (Point3d.millimeters -800 -550 350)
    ]

buildingBlock3 : List (Block3d Meters BodyCoordinates)
buildingBlock3 =
    [ Block3d.from
        (Point3d.millimeters 100 -1000 0)
...
camera =
    Camera3d.perspective
        { viewpoint =
            Viewpoint3d.lookAt
                { eyePoint = Point3d.millimeters 250 4000 2000
                , focalPoint = Point3d.millimeters 200 -450 400
