...
buildingBlock1 =
    [ Block3d.from
        ...
        (Point3d.millimeters -500 -1700 1000)
    ]

buildingBlock2 : List (Block3d Meters BodyCoordinates) --rightmost
buildingBlock2 =
    [ Block3d.from
        (Point3d.millimeters -500 -2000 0)
        (Point3d.millimeters -800 500 1000)
    ]
...
buildingBlock3 =
    [ Block3d.from
        (Point3d.millimeters 1000 -2000 0)
        (Point3d.millimeters 1300 500 1000)
    ]
...
ball =
    Body.compound (List.map Physics.Shape.sphere ballBlock) Ball
        |> Body.withBehavior (Body.dynamic (kilograms 250))

building1 : Body Id
building1 =
    Body.compound (List.map Physics.Shape.block buildingBlock1) Building1
        |> Body.withBehavior (Body.dynamic (kilograms 30000))
